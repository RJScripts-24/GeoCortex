  ...
  return (
    <>
      ...
      {showConsultant && (
        <div 
          id="sidebar-panel"
          className={`fixed right-4 top-20 ${enlarged ? 'w-[700px] max-h-[95vh]' : 'w-96 max-h-[90vh]'} bg-black/60 backdrop-blur-xl border border-white/10 rounded-2xl p-6 text-white overflow-y-auto z-[101] shadow-2xl transition-all duration-300`}
        >
          <div className="flex items-center gap-3 mb-6 border-b border-white/10 pb-4">
            ...
            <button
              className="ml-auto px-2 py-1 text-xs text-gray-400 hover:text-white border border-gray-700 rounded mr-2"
